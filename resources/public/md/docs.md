...
Two middleware functions are provided by default in the `mscrobbler.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `mscrobbler.handler` namespace to manage the enabled middleware.
